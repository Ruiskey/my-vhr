          ...
          <el-row>
            <el-col :span="6">
              <el-form-item label="姓名:" prop="name">
                <el-input placeholder="请输入员工姓名" prefix-icon="el-icon-edit" v-model="emp.name"
                          style="width: 150px" size="mini"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="5">
              <el-form-item label="性别:" prop="gender">
                <el-radio-group v-model="emp.gender" style="width: 120px;">
                  <el-radio label="男">男</el-radio>
                  <el-radio label="女" style="margin-left: 3px">女</el-radio>
                </el-radio-group>
              </el-form-item>
            </el-col>
            <el-col :span="6">
          ...
          <el-row>
            ...
            <el-col :span="5">
              <el-form-item label="籍贯:" prop="nativePlace">
                <el-input size="mini" prefix-icon="el-icon-edit" v-model="emp.nativePlace" placeholder="籍贯"
                          style="width: 120px"/>
              </el-form-item>
            </el-col>
            <el-col :span="6">
              <el-form-item label="电子邮箱:" prop="email">
                <el-input size="mini" prefix-icon="el-icon-message" v-model="emp.email" placeholder="电子邮箱"
                          style="width: 150px"/>
              </el-form-item>
            </el-col>
            <el-col :span="7">
              <el-form-item label="联系地址:" prop="address">
                <el-input size="mini" prefix-icon="el-icon-edit" v-model="emp.address" placeholder="联系地址"
                          style="width: 200px"/>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            ...
            <el-col :span="7">
              <el-form-item label="电话号码:" prop="phone">
                <el-input size="mini" prefix-icon="el-icon-phone" v-model="emp.phone" placeholder="电话号码"
                          style="width: 200px"/>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            ...
            <el-col :span="6">
              <el-form-item label="毕业院校:" prop="school">
                <el-input size="mini" prefix-icon="el-icon-edit" v-model="emp.school" placeholder="毕业院校"
                          style="width: 150px"/>
              </el-form-item>
            </el-col>
            <el-col :span="7">
              <el-form-item label="专业名称:" prop="specialty">
                <el-input size="mini" prefix-icon="el-icon-edit" v-model="emp.specialty" placeholder="专业名称"
                          style="width: 200px"/>
              </el-form-item>
            </el-col>
          </el-row>
          ...
          <el-row>
            <el-col :span="8">
              <el-form-item label="身份证号码:" prop="idCard">
                <el-input size="mini" prefix-icon="el-icon-edit" v-model="emp.idCard" placeholder="身份证号码"
                          style="width: 180px"/>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="性别:" prop="engageForm">
                <el-radio-group v-model="emp.engageForm" style="width: 220px;">
            ...
            <el-col :span="8">
              <el-form-item label="婚姻状况:" prop="wedlock">
                <el-radio-group v-model="emp.wedlock" style="width: 220px;">
